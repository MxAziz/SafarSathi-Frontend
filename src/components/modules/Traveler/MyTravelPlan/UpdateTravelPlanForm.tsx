...
interface UpdateTravelPlanFormProps {
  formAction: (payload: FormData) => void;
  state: IInputErrorState;
  isPending: boolean;
  defaultValues: ITravelPlan; // Mandatory for update
}

export default function UpdateTravelPlanForm({
  formAction,
  state,
  isPending,
  defaultValues,
}: UpdateTravelPlanFormProps) {
  const [travelType, setTravelType] = useState<string>(
    defaultValues.travelType || TravelType.SOLO
  );
    ...
    <form action={formAction} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            name="startDate"
            type="date"
            defaultValue={formatDate(defaultValues.startDate)}
            className={
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            name="endDate"
            type="date"
            defaultValue={formatDate(defaultValues.endDate)}
            className={
      ...
      <div className="flex items-center space-x-2 bg-secondary/20 p-3 rounded-lg">
        <Switch
          id="visibility"
          name="visibility"
          defaultChecked={defaultValues.visibility}
        />
